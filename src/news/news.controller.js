...
var NewsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('news'), (0, common_1.Controller)('news')];
    ...
    var NewsController = _classThis = /** @class */ (function () {
        function NewsController_1(service) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
        }
        // Lista (opcional: filtrar por published)
        NewsController_1.prototype.list = function (published) {
            var p = published === undefined ? undefined : published === 'true';
            return this.service.list(p);
        };
        // Detalle por slug
        NewsController_1.prototype.get = function (slug) {
            return this.service.getBySlug(slug);
        };
        // Crear
        NewsController_1.prototype.create = function (dto) {
            return this.service.create(dto);
        };
        // Actualizar -> id numérico
        NewsController_1.prototype.update = function (id, dto) {
            return this.service.update(id, dto);
        };
        // Eliminar -> id numérico
        NewsController_1.prototype.remove = function (id) {
    ...
    (function () {
        ...
        _get_decorators = [(0, common_1.Get)(':slug')];
