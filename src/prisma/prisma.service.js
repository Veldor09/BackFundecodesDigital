...
var PrismaService = function () {
    ...
    var PrismaService = _classThis = /** @class */ (function (_super) {
        ...
        function PrismaService_1() {
            ...
            var maybeUse = _this === null || _this === void 0 ? void 0 : _this.$use;
            if (typeof maybeUse === 'function') {
                maybeUse.call(_this, function (params, next) { return __awaiter(_this, void 0, void 0, function () {
                    var action, data, title, place, hasTitle, hasPlace;
                    var _a, _b;
                    return __generator(this, function (_c) {
                        if ((params === null || params === void 0 ? void 0 : params.model) === 'Project') {
                            action = params.action;
                            data = ((_b = (_a = params.args) === null || _a === void 0 ? void 0 : _a.data) !== null && _b !== void 0 ? _b : {});
                            if (action === 'create') {
                                if (!data.slug || typeof data.slug !== 'string' || data.slug.trim() === '') {
                                    title = typeof data.title === 'string' ? data.title.trim() : '';
                                    place = typeof data.place === 'string' ? data.place.trim() : '';
                                    if (title && place)
                                        data.slug = slugify("".concat(title, "-").concat(place));
                                }
                                else {
                                ...
                                if (typeof data.slug === 'string' && data.slug.trim().length > 0) {
                                    ...
                                    hasTitle = typeof data.title === 'string' && data.title.trim().length > 0;
                                    hasPlace = typeof data.place === 'string' && data.place.trim().length > 0;
                                    if (hasTitle && hasPlace) {
                                        data.slug = slugify("".concat(data.title.trim(), "-").concat(data.place.trim()));
                                    }
                                }
                            }
