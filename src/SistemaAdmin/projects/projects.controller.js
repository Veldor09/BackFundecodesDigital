...
var ProjectsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('projects'), (0, common_1.Controller)('projects')];
    ...
    var ProjectsController = _classThis = /** @class */ (function () {
        function ProjectsController_1(service) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
        }
        ProjectsController_1.prototype.list = function (query) {
            return this.service.list(query);
        };
        ProjectsController_1.prototype.get = function (slug) {
            return this.service.getBySlug(slug);
        };
        ProjectsController_1.prototype.create = function (dto) {
            return this.service.create(dto);
        };
        ProjectsController_1.prototype.update = function (id, dto) {
