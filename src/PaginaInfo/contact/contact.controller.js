...
var ContactController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('contact'), (0, common_1.Controller)('contact')];
    ...
    var ContactController = _classThis = /** @class */ (function () {
        function ContactController_1(service) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
        }
        ContactController_1.prototype.create = function (dto) {
