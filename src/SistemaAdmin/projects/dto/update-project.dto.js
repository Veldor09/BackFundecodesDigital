...
var UpdateProjectDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _title_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return trim(value);
            ...
            _category_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return trim(value);
                }), (0, class_validator_1.IsNotEmpty)({ message: 'category no puede estar vacío' })];
            _place_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return trim(value);
                }), (0, class_validator_1.IsNotEmpty)({ message: 'place no puede estar vacío' })];
            _area_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return trim(value);
